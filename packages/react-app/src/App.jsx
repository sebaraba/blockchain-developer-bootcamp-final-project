...
function App(props) {
  ...
  const externalContractBalance = useBalance(
    localProvider,
    readContracts && readContracts.externalContract ? readContracts.externalContract.address : null,
  );
  if (DEBUG) console.log("💵 externalContractBalance", externalContractBalance);
