...
*/
  ...
  const externalContract = await deploy("ExternalContract")

  const stakerContract = await deploy("Staker",[ externalContract.address ]) // <-- add in constructor args like line 16 vvvv
